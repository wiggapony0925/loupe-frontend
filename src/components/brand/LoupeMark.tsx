...
export function LoupeMark({ size = 28, color = palette.ink.default }: LoupeMarkProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      ...
      <Circle cx={13} cy={13} r={3.4} stroke={palette.accent.mint} strokeWidth={1.2} />
      <Path
        ...
        strokeLinecap="round"
      />
      <Path d="M19.6 19.6 L27 27" stroke={color} strokeWidth={2.4} strokeLinecap="round" />
    </Svg>
  );
}
